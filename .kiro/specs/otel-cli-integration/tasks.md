...
-
  ...
  - [ ] 3.2 Integrate OTEL manager into CLI initialization
...
-
  ...
  - [ ] 4.1 Extend TDTrinoClient with OTEL support
    ...
    - Implement NewTDTrinoClientWithTracing constructor function
  ...
  - [ ] 4.3 Implement Trino metrics collection
...
-
  ...
  - [ ] 5.3 Implement API call metrics and error tracking
...
-
  ...
  - [ ] 7.2 Implement secure credential handling
...
-
  ...
  - [ ] 8.2 Add export failure handling and retry logic
...
-
  ...
  - [ ] 9.2 Add integration tests for instrumented clients
  ...
  - [ ] 9.3 Implement performance and degradation tests
